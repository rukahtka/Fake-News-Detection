# -*- coding: utf-8 -*-
"""
Created on Fri Feb  1 17:35:16 2019
...
class TfidfFeatureGenerator(FeatureGenerator):
    ...
    def process(self, df):
        ...
        def cat_text(x):
            res =  (' '.join(x['Headline_unigram']) + ' '.join(x['articleBody_unigram']))
            return res
