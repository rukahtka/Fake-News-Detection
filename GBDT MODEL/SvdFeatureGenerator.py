# -*- coding: utf-8 -*-
"""
Created on Fri Feb  1 17:14:33 2019
...
class SvdFeatureGenerator(FeatureGenerator):
    ...
    def process(self, df):
        ...
        print( 'headline svd features of training set saved in ' , outfilename_hsvd_train)
        ...
        if n_test > 0:
            ...
            print ('headline svd features of test set saved in ',  outfilename_hsvd_test)
        ...
        print ('body svd features of training set saved in ',  outfilename_bsvd_train)
        ...
        if n_test > 0:
            ...
            print ('body svd features of test set saved in ' , outfilename_bsvd_test)
        ...
        print ('svd sim. features of training set saved in ' , outfilename_simsvd_train)
        ...
        if n_test > 0:
            ...
            print ('svd sim. features of test set saved in ' , outfilename_simsvd_test)
