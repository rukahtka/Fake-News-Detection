# -*- coding: utf-8 -*-
"""
Created on Fri Feb  1 17:13:17 2019
...
class SentimentFeatureGenerator(FeatureGenerator):
    ...
    def process(self, df):
        ...
        if n_test > 0:
            ...
            print ( 'headline sentiment features of test set saved in ' , outfilename_hsenti_test)
        ...
        if n_test > 0:
            ...
            print ('body sentiment features of test set saved in ' , outfilename_bsenti_test)
    ...
    def read(self, header='train'):
        ...
        filename_hsenti = header+".headline.senti.pkl"
        with open(filename_hsenti, "rb") as infile:
            headlineSenti = pickle.load(infile)

        filename_bsenti = header+".body.senti.pkl"
